...
// مجلد الرفع فقط — ما نحتاج processed بعد الآن
...
app.post('/upload', upload.single('video'), (req, res) => {
    ...
    res.json({ success: true, fileId, filePath, sizeMB });
});
...
app.post('/api/start', async (req, res) => {
    try {
        ...
        console.log(`[/api/start] filePath=${filePath}`);
        const result = await startStream(filePath, fileId);
